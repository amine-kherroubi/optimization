...
## Improved Workflow (config-driven, recommended)
...
- `repair_model_training.ipynb` — original step-by-step notebook (local execution)
- `../offline_training/offline_training_improve.ipynb` — Colab-ready pipeline
- `../offline_training/repair_model_trainig_improvement.ipynb` — documented walkthrough with rationale
