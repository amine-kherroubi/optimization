...
- `relocation` starts from a First Fit Decreasing solution and tries to empty light bins.
- `swap` runs relocation and then tries pairwise swaps followed by additional relocations.
